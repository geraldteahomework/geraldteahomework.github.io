...
I18N.sq = {
  ...
  'First time here. You will be the admin: choose your first name and a password.': 'Hera e parë këtu. Ti do të jesh administratori: zgjidh emrin dhe një fjalëkalim.',
  'Create your account. You need the invite code from the admin.': 'Krijo llogarinë tënde. Të duhet kodi i ftesës nga administratori.',
  'Sign in with your first name and password.': 'Hyr me emrin dhe fjalëkalimin tënd.',
  'Set up & continue': 'Krijo & vazhdo',
  'Create account': 'Krijo llogarinë',
  'Already have an account?': 'Ke tashmë llogari?',
  'New here?': 'I ri këtu?',
  'Create an account': 'Krijo një llogari',
  'Account': 'Llogaria',
  'Signed in as {name} (admin).': 'Hyrë si {name} (administrator).',
  'Signed in as {name}.': 'Hyrë si {name}.',
  'Your password. Each device asks for it once, then remembers for a year.': 'Fjalëkalimi yt. Çdo pajisje e kërkon një herë, pastaj e mban mend për një vit.',
  'Download a file with all of your homework, grades and settings to keep somewhere safe. The server also saves a copy of everyone\'s data once a day.': 'Shkarko një skedar me të gjitha detyrat, notat dhe cilësimet e tua për ta ruajtur diku të sigurt. Serveri ruan gjithashtu një kopje të të dhënave të të gjithëve një herë në ditë.',
  'Download my backup': 'Shkarko kopjen time',
  'Put your data back from a backup file (one you downloaded, or the server\'s daily copy). Only your own homework, grades and settings are replaced; a safety copy is saved first and your password is kept.': 'Rikthe të dhënat e tua nga një skedar kopjeje (një që ke shkarkuar, ose kopja ditore e serverit). Zëvendësohen vetëm detyrat, notat dhe cilësimet e tua; fillimisht ruhet një kopje sigurie dhe fjalëkalimi yt mbetet.',
  'People': 'Njerëzit',
  'Everyone with an account. New people join from the sign-in page with the invite code; you can also add someone here, reset a forgotten password, or remove an account (that deletes their data).': 'Të gjithë me llogari. Njerëzit e rinj bashkohen nga faqja e hyrjes me kodin e ftesës; mund të shtosh dikë edhe këtu, të rivendosësh një fjalëkalim të harruar ose të heqësh një llogari (kjo fshin të dhënat e tyre).',
  'Copy': 'Kopjo',
  'New code': 'Kod i ri',
  'First password (they can change it)': 'Fjalëkalimi i parë (mund ta ndryshojnë)',
  '+ Add person': '+ Shto person',
  'Import someone\'s old copy': 'Importo kopjen e vjetër të dikujt',
  'A backup file from the old one-person version becomes a new account, with its password, settings, homework and grades.': 'Një skedar kopjeje nga versioni i vjetër për një person bëhet llogari e re, me fjalëkalimin, cilësimet, detyrat dhe notat e tij.',
  'Import': 'Importo',
  'admin': 'administrator',
  '{n} items': '{n} detyra',
  'last seen {when}': 'parë së fundi {when}',
  'never signed in': 'nuk ka hyrë kurrë',
  'Rename': 'Riemërto',
  'Reset password': 'Rivendos fjalëkalimin',
  'Invite code copied.': 'Kodi i ftesës u kopjua.',
  'Make a new invite code? The old one stops working.': 'Të bëj një kod të ri ftese? I vjetri nuk punon më.',
  'New invite code: {code}': 'Kodi i ri i ftesës: {code}',
  'Account for {name} created. Tell them their first password; they can change it in Settings.': 'Llogaria për {name} u krijua. Tregoji fjalëkalimin e parë; mund ta ndryshojë te Cilësimet.',
  'New first name for {name}:': 'Emri i ri për {name}:',
  'Renamed.': 'U riemërtua.',
  'New password for {name} (at least 6 characters). They sign in with it and can change it afterwards.': 'Fjalëkalimi i ri për {name} (të paktën 6 karaktere). Hyn me të dhe mund ta ndryshojë më pas.',
  'Password for {name} reset. Their other devices will need to sign in again.': 'Fjalëkalimi për {name} u rivendos. Pajisjet e tjera do të duhet të hyjnë përsëri.',
  'Remove {name} and everything they have entered? This cannot be undone.': 'Të heq {name} dhe gjithçka që ka shënuar? Kjo nuk kthehet dot.',
  '{name} removed.': '{name} u hoq.',
  'Give the first name and choose the .db file.': 'Jep emrin dhe zgjidh skedarin .db.',
  'Importing…': 'Duke importuar…',
  'Imported {name}: {items} items, {grades} grades. They sign in with the password from their old copy.': 'U importua {name}: {items} detyra, {grades} nota. Hyn me fjalëkalimin e kopjes së vjetër.',
